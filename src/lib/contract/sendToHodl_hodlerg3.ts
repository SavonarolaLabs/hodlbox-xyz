...
export async function mintHodlErg3BoxTx(holderBase58PK: string, utxos: Array<any>, height: number, assets: any, treasure:Treasure,  uiFeeBase58PK: string, targetPrice: bigint): any {
